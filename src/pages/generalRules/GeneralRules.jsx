      ...
      <div className='flex mt-2 space-x-4'>
        ...
        <div className='w-full'>
          ...
          <div className='flex flex-col items-center w-full md:w-3/4'>
            ...
            <Accordion
              bordered
              className='w-full mb-4 mr-4 overflow-visible text-white bg-gray-800'>
              <Accordion.Panel
                header='Carrying Capacity'
                expanded={activePanels[0]}
                onSelect={() => handleTogglePanel(0)}>
                <div className='flex flex-col space-y-3'>
                  <div className='flex flex-col gap-3 sm:flex-row sm:items-center items-left'>
                    <span className='ml-1 font-semibold sm:ml-0'>Size:</span>
                    <Select
                      id='size-select'
                  ...
                  <div className='text-sm'>
                    ...
                    carry. While dragging, lifting, or pushing weight in excess of the maximum
              ...
              <Accordion.Panel
                ...
                <div className='flex flex-col space-y-3'>
                  <div className='text-sm'>
                    <span className='font-medium'>Unarmed Strike</span> - A melee attack that
                    involves you using your body to damage,{" "}
                    <span className='font-semibold'>grapple, or shove</span> a target within 5 feet
                    of you.
                  </div>
                  <div className='text-sm'>
                  ...
                  <div className='text-sm'>
                    <span className='font-medium'>Shove</span> - The target must succeed on a
                    Strength or Dexterity saving throw (it chooses which), or you either push it 5
                    feet away or cause it to have the Prone condition. This shove is possible only
                    if the target is no more than one size larger than you.
                  </div>
                  <div>
                    Your DC for these saving throws (and any grapple escape attempts) is{" "}
                    <span
                      className='font-bold text-yellow-400'
                      data-tooltip-id='grapple-dc-tooltip'>
              ...
              <Accordion.Panel
                ...
                <div className='flex flex-col space-y-3'>
                  ...
                  <div>
                    You can hold your breath for <BreathTooltip conMod={conMod} /> before
                    suffocating.
                  </div>
                </div>
                <div className='flex'>
              ...
              <Accordion.Panel
                ...
                <div className='flex flex-col space-y-2'>
                  <div className='text-sm'>
                    ...
                    <br />
                    You cover a number of feet up to your Strength score if you move at least 10
                  ...
                  <div className='text-sm'>
                    ...
                    chasm. At your DM&apost;s option, you must succeed on a DC 10 Strength
                    (Athletics) check to clear a low obstacle (no taller than a quarter of the
                    jump&apost;s distance), such as a hedge or low wall. Otherwise, you hit the
                    obstacle.
                  </div>
                  <div>
